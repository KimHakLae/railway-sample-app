  ...
  return (
    <Card className="group hover:scale-[1.02] transition-all cursor-default">
      <div className="flex justify-between items-start mb-4">
        <span className={`px-3 py-1 rounded-full text-[10px] font-black ${CATEGORY_INFO[item.category]?.style || "bg-gray-100 text-gray-500 dark:text-gray-400"}`}>
        ...
        <div className="flex gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
          ...
          <button
            ...
            className="p-2 hover:bg-red-50 text-red-500 dark:text-red-400 rounded-lg transition-colors"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="space-y-1">
        <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-brand-600 transition-colors">{item.name}</h3>
      ...
      <div className="mt-6 pt-6 border-t border-gray-100 dark:border-slate-700 flex items-center justify-between">
        <div className="flex flex-col">
          ...
          <span className={`text-lg font-black ${totalQty > 0 ? "text-gray-900 dark:text-white" : "text-gray-300"}`}>
