  ...
  return (
    ...
    `}>
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="p-2 rounded-xl bg-gray-50 dark:bg-slate-900 text-gray-400 hover:bg-white dark:bg-slate-800 hover:text-brand-600 hover:shadow-md transition-all active:scale-90"
            aria-label="수정"
          >
          ...
          <button 
            ...
            className="p-2 rounded-xl bg-gray-50 dark:bg-slate-900 text-gray-300 hover:bg-white dark:bg-slate-800 hover:text-red-500 dark:text-red-400 hover:shadow-md transition-all active:scale-90" 
            aria-label="삭제"
          >
      ...
      <div className="grid grid-cols-2 gap-4 pt-2">
        <div className="p-3 bg-gray-50 dark:bg-slate-900/50 rounded-2xl border border-gray-100 dark:border-slate-700/50">
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Quantity</p>
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-black text-gray-900 dark:text-white">{item.quantity}</span>
      ...
      <div className="flex items-center justify-between pt-2">
        ...
        <label className="flex items-center gap-2 cursor-pointer group">
          <span className="text-[11px] font-bold text-gray-400 group-hover:text-red-500 dark:text-red-400 transition-colors">긴급설정</span>
          <div className="relative">
            ...
            <div className="absolute top-0.5 left-0.5 w-4 h-4 bg-white dark:bg-slate-800 rounded-full shadow-sm transition-all peer-checked:translate-x-4"></div>
          </div>
        </label>
      </div>
    </div>
